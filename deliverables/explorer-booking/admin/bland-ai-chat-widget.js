// Bland AI Customer-Facing Chat Widget

class BlandAIChatWidget {
  ...
  render() {
    this.container.innerHTML = `
      <div class="chat-widget bg-white border rounded-lg shadow-lg flex flex-col h-96 w-80">
...
// Initialize Bland AI Chat Widget on page load
document.addEventListener('DOMContentLoaded', () => {
  const chatContainer = document.getElementById('blandAIChatWidgetContainer');
  if (chatContainer) {
    window.blandAIChatWidget = new BlandAIChatWidget('blandAIChatWidgetContainer');
  }
});
